...
if __name__ == '__main__':
    ...
    targetList = {
        "https://www.yangguiweihuo.com": 1,
        "https://www.yangguiweihuo.com": 2
    }
    target = sys.argv[0]
    ...
    name = ''
    messege = 'success'
    if str(target).split(".com")[0] in targetList:
        is_success, name, messege = topaqu(target, str(target).split(".com")[0],
                                           targetList.get(str(target).split(".com")[0]))
    else:
        messege = '没有当前目标源'
